...
var app = (function () {
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "navbar-link svelte-1qfn9lh");
    			attr_dev(a0, "href", "#");
    			add_location(a0, file$i, 68, 8, 1819);
    			attr_dev(a1, "class", "navbar-link svelte-1qfn9lh");
    			attr_dev(a1, "href", "#skills");
    			add_location(a1, file$i, 69, 8, 1872);
    			attr_dev(a2, "class", "navbar-link svelte-1qfn9lh");
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file$i, 70, 8, 1930);
    			attr_dev(a3, "class", "navbar-link svelte-1qfn9lh");
    			attr_dev(a3, "href", "#contact");
    			add_location(a3, file$i, 71, 8, 1992);
    			attr_dev(nav, "class", "navigation-bar svelte-1qfn9lh");
    			add_location(nav, file$i, 66, 4, 1726);
    			attr_dev(div, "class", "navigation-bar-container svelte-1qfn9lh");
    			add_location(div, file$i, 65, 0, 1682);
    		},
    ...
    const file$h = "src\\components\\welcome.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "svelte-p75hal");
    			add_location(path0, file$h, 91, 12, 2015);
    			...
    			attr_dev(path1, "class", "svelte-p75hal");
    			add_location(path1, file$h, 92, 12, 2450);
    			add_location(g, file$h, 90, 9, 1998);
    			attr_dev(svg, "width", "328");
    			attr_dev(svg, "height", "368");
    			attr_dev(svg, "viewBox", "0 0 328 368");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "id", "logo");
    			attr_dev(svg, "class", "svelte-p75hal");
    			add_location(svg, file$h, 89, 4, 1890);
    			attr_dev(h2, "id", "hey");
    			attr_dev(h2, "class", "svelte-p75hal");
    			add_location(h2, file$h, 96, 8, 3940);
    			attr_dev(p, "id", "hook");
    			attr_dev(p, "class", "svelte-p75hal");
    			add_location(p, file$h, 97, 8, 3981);
    			attr_dev(div0, "id", "h2-container");
    			attr_dev(div0, "class", "svelte-p75hal");
    			add_location(div0, file$h, 95, 4, 3907);
    			attr_dev(div1, "class", "info-container svelte-p75hal");
    			attr_dev(div1, "id", "welcome");
    			add_location(div1, file$h, 88, 0, 1843);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$g = "src\\components\\logo_link.svelte";
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$g, 60, 12, 6669);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 59, 8, 6565);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$g, 56, 12, 5455);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 55, 8, 5351);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$g, 52, 12, 4195);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 51, 8, 4091);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$g, 47, 12, 3419);
    			...
    			add_location(path1, file$g, 48, 12, 3523);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 30 30");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 46, 8, 3315);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$g, 43, 12, 2737);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 30 30");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 42, 8, 2633);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$g, 39, 12, 1800);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 38, 8, 1696);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$g, 35, 12, 896);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", svg_class_value = "" + (/*icon*/ ctx[1] + "-logo" + " logo"));
    			add_location(svg, file$g, 34, 8, 792);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(34:4) {#if icon == Icons.Github}",
    		ctx
    	});
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$g, 32, 0, 679);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Logo_link extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$g, create_fragment$g, safe_not_equal, { link: 0, icon: 1 });
    ...
    const file$f = "src\\components\\skill_info.svelte";
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t2 = text(t2_value);
    			add_location(h2, file$f, 100, 20, 2328);
    			add_location(p, file$f, 101, 20, 2370);
    			attr_dev(div, "class", "details-card description");
    			add_location(div, file$f, 99, 16, 2268);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(99:12) {#if \\\"description\\\" in obj}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$f, 106, 20, 2544);
    			attr_dev(div0, "class", "list svelte-1qpq76h");
    			add_location(div0, file$f, 107, 20, 2579);
    			attr_dev(div1, "class", "details-card tags svelte-1qpq76h");
    			add_location(div1, file$f, 105, 16, 2491);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h2);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(strong, "class", "tag svelte-1qpq76h");
    			add_location(strong, file$f, 109, 28, 2679);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(109:24) {#each obj[\\\"tags\\\"] as tag}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$f, 116, 20, 2923);
    			attr_dev(div0, "class", "list svelte-1qpq76h");
    			add_location(div0, file$f, 117, 20, 2959);
    			attr_dev(div1, "class", "details-card links svelte-1qpq76h");
    			add_location(div1, file$f, 115, 16, 2869);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h2);
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(119:24) {#each obj[\\\"links\\\"] as link}",
    		ctx
    	});
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$f, 95, 12, 2125);
    			attr_dev(header, "class", "svelte-1qpq76h");
    			add_location(header, file$f, 94, 8, 2103);
    			attr_dev(div0, "class", "details svelte-1qpq76h");
    			add_location(div0, file$f, 97, 8, 2189);
    			attr_dev(div1, "class", div1_class_value = "info-box " + /*obj*/ ctx[0]["background"] + " svelte-1qpq76h");
    			add_location(div1, file$f, 93, 4, 2051);
    			attr_dev(div2, "class", "skill-info background svelte-1qpq76h");
    			add_location(div2, file$f, 92, 0, 1931);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*obj*/ 1 && div1_class_value !== (div1_class_value = "info-box " + /*obj*/ ctx[0]["background"] + " svelte-1qpq76h")) {
    ...
    class Skill_info extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { obj: 0 });
    ...
    const file$e = "src\\components\\skill_button.svelte";
    ...
    // (70:36)       <button class="link-button skill-button {skill_obj["background"]}
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h3 = element("h3");
    			t = text(t_value);
    			attr_dev(h3, "class", "svelte-1szks3r");
    			add_location(h3, file$e, 71, 8, 2384);
    			attr_dev(button, "class", "link-button skill-button " + /*skill_obj*/ ctx[6]["background"] + " svelte-1szks3r");
    			add_location(button, file$e, 70, 4, 2260);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(70:36)       <button class=\\\"link-button skill-button {skill_obj[\\\"background\\\"]}",
    		ctx
    	});
    ...
    class Skill_button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { json: 2 });
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "section-title svelte-8j7hs");
    			add_location(h1, file$d, 23, 4, 477);
    			attr_dev(h20, "class", "section-title svelte-8j7hs");
    			add_location(h20, file$d, 26, 8, 621);
    			attr_dev(div0, "class", "info-card-container svelte-8j7hs");
    			add_location(div0, file$d, 27, 8, 674);
    			attr_dev(div1, "class", "languages-container");
    			add_location(div1, file$d, 25, 4, 578);
    			attr_dev(h21, "class", "section-title svelte-8j7hs");
    			add_location(h21, file$d, 44, 8, 1508);
    			attr_dev(div2, "class", "info-card-container svelte-8j7hs");
    			add_location(div2, file$d, 45, 8, 1583);
    			attr_dev(div3, "class", "libraies-engines-and-frameworks-container");
    			add_location(div3, file$d, 43, 4, 1443);
    			attr_dev(h22, "class", "section-title svelte-8j7hs");
    			add_location(h22, file$d, 63, 8, 2471);
    			attr_dev(div4, "class", "info-card-container svelte-8j7hs");
    			add_location(div4, file$d, 64, 8, 2540);
    			attr_dev(div5, "class", "misc-tech-container");
    			add_location(div5, file$d, 62, 4, 2428);
    			attr_dev(div6, "class", "info-container svelte-8j7hs");
    			attr_dev(div6, "id", "skills");
    			add_location(div6, file$d, 22, 0, 431);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src\\components\\project-cards\\project_card.svelte";
    const get_logo_link_container_slot_changes = dirty => ({});

    const get_logo_link_container_slot_context = ctx => ({
    	class: "logo-link-container svelte-2oibxt"
    });
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "bg-image svelte-2oibxt");
    			set_style(div0, "background-image", "url(" + /*background_url*/ ctx[2] + ")");
    			add_location(div0, file$c, 58, 4, 1267);
    			add_location(h1, file$c, 60, 8, 1389);
    			add_location(p, file$c, 61, 8, 1415);
    			attr_dev(div1, "class", "project-card-details");
    			add_location(div1, file$c, 59, 4, 1345);
    			attr_dev(div2, "class", "project-card svelte-2oibxt");
    			add_location(div2, file$c, 57, 0, 1235);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\project-cards\portfolio.svelte generated by Svelte v3.42.5 */
    const file$b = "src\\components\\project-cards\\portfolio.svelte";

    // (11:4) 
    function create_status_badge_slot$7(ctx) {
    	let div;
    	let img0;
    	let img0_src_value;
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$b, 11, 8, 346);
    			...
    			add_location(img1, file$b, 12, 8, 469);
    			attr_dev(div, "slot", "status-badge");
    			add_location(div, file$b, 10, 4, 311);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_status_badge_slot$7.name,
    		type: "slot",
    		source: "(11:4) ",
    		ctx
    	});
    ...
    // (15:4) 
    function create_logo_link_container_slot$8(ctx) {
    	let div;
    	let logolink;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 14, 4, 599);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_logo_link_container_slot$8.name,
    		type: "slot",
    		source: "(15:4) ",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	projectcard = new Project_card({
    			props: {
    				...
    				$$slots: {
    					"logo-link-container": [create_logo_link_container_slot$8],
    					"status-badge": [create_status_badge_slot$7]
    				},
    				$$scope: { ctx }
    			},
    			$$inline: true
    ...
    /* src\components\project-cards\cellular_automata.svelte generated by Svelte v3.42.5 */
    const file$a = "src\\components\\project-cards\\cellular_automata.svelte";

    // (11:4) 
    function create_logo_link_container_slot$7(ctx) {
    	let div;
    	let logolink;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$a, 10, 4, 328);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_logo_link_container_slot$7.name,
    		type: "slot",
    		source: "(11:4) ",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	projectcard = new Project_card({
    			props: {
    				...
    				$$slots: {
    					"logo-link-container": [create_logo_link_container_slot$7]
    				},
    				$$scope: { ctx }
    			},
    			$$inline: true
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Cellular_automata', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Cellular_automata> was created with unknown prop '${key}'`);
    	});
    ...
    class Cellular_automata extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\project-cards\sorting_algorithm_visualizer.svelte generated by Svelte v3.42.5 */
    const file$9 = "src\\components\\project-cards\\sorting_algorithm_visualizer.svelte";

    // (11:4) 
    function create_status_badge_slot$6(ctx) {
    	let div;
    	let img0;
    	let img0_src_value;
    	let t0;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$9, 11, 8, 389);
    			...
    			add_location(img1, file$9, 12, 8, 532);
    			...
    			add_location(img2, file$9, 13, 8, 674);
    			attr_dev(div, "slot", "status-badge");
    			add_location(div, file$9, 10, 4, 354);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_status_badge_slot$6.name,
    		type: "slot",
    		source: "(11:4) ",
    		ctx
    	});
    ...
    // (16:4) 
    function create_logo_link_container_slot$6(ctx) {
    	let div;
    	let logolink;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$9, 15, 4, 823);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_logo_link_container_slot$6.name,
    		type: "slot",
    		source: "(16:4) ",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	projectcard = new Project_card({
    			props: {
    				...
    				$$slots: {
    					"logo-link-container": [create_logo_link_container_slot$6],
    					"status-badge": [create_status_badge_slot$6]
    				},
    				$$scope: { ctx }
    			},
    			$$inline: true
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Sorting_algorithm_visualizer', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Sorting_algorithm_visualizer> was created with unknown prop '${key}'`);
    	});
    ...
    class Sorting_algorithm_visualizer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "Sorting_algorithm_visualizer",
    			options,
    			id: create_fragment$9.name
    		});
    	}
    ...
    /* src\components\project-cards\rust_algorithms.svelte generated by Svelte v3.42.5 */
    const file$8 = "src\\components\\project-cards\\rust_algorithms.svelte";

    // (11:4) 
    function create_status_badge_slot$5(ctx) {
    	let img;
    	let img_src_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$8, 10, 4, 309);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_status_badge_slot$5.name,
    		type: "slot",
    		source: "(11:4) ",
    		ctx
    	});
    ...
    function create_logo_link_container_slot$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$8, 11, 4, 459);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink, div, null);
    	...
    	projectcard = new Project_card({
    			props: {
    				...
    				$$slots: {
    					...
    					"status-badge": [create_status_badge_slot$5]
    				},
    				$$scope: { ctx }
    			},
    			$$inline: true
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Rust_algorithms', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Rust_algorithms> was created with unknown prop '${key}'`);
    	});
    ...
    class Rust_algorithms extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\project-cards\rust_data_structures.svelte generated by Svelte v3.42.5 */
    const file$7 = "src\\components\\project-cards\\rust_data_structures.svelte";
    ...
    function create_status_badge_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Build Status");
    			add_location(img, file$7, 10, 4, 364);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_logo_link_container_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$7, 11, 4, 519);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink, div, null);
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Rust_data_structures', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Rust_data_structures> was created with unknown prop '${key}'`);
    	});
    ...
    class Rust_data_structures extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$6 = "src\\components\\project-cards\\fixed_vectors.svelte";
    ...
    function create_status_badge_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$6, 11, 8, 378);
    			...
    			add_location(img1, file$6, 12, 8, 506);
    			...
    			add_location(img2, file$6, 13, 8, 623);
    			...
    			add_location(img3, file$6, 14, 8, 726);
    			...
    			add_location(img4, file$6, 15, 8, 852);
    			attr_dev(div, "slot", "status-badge");
    			add_location(div, file$6, 10, 4, 343);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img0);
    ...
    function create_logo_link_container_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$6, 17, 4, 979);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    /* src\components\project-cards\lists.svelte generated by Svelte v3.42.5 */
    const file$5 = "src\\components\\project-cards\\lists.svelte";
    ...
    function create_status_badge_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			img5 = element("img");
    			if (!src_url_equal(img0.src, img0_src_value = "https://img.shields.io/github/workflow/status/c1m50c/lists/Build?style=for-the-badge")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "Build");
    			add_location(img0, file$5, 11, 8, 350);
    			if (!src_url_equal(img1.src, img1_src_value = "https://img.shields.io/docsrs/lists/latest?style=for-the-badge")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "Docs");
    			add_location(img1, file$5, 12, 8, 470);
    			if (!src_url_equal(img2.src, img2_src_value = "https://img.shields.io/crates/v/lists?color=orange&style=for-the-badge")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "CratesIO");
    			add_location(img2, file$5, 13, 8, 567);
    			if (!src_url_equal(img3.src, img3_src_value = "https://img.shields.io/crates/l/lists?style=for-the-badge")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "License");
    			add_location(img3, file$5, 14, 8, 676);
    			if (!src_url_equal(img4.src, img4_src_value = "https://img.shields.io/tokei/lines/github/c1m50c/lists?style=for-the-badge")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Lines of Code");
    			add_location(img4, file$5, 15, 8, 771);
    			if (!src_url_equal(img5.src, img5_src_value = "https://img.shields.io/github/stars/c1m50c/lists?style=for-the-badge")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "Github Stars");
    			add_location(img5, file$5, 16, 8, 889);
    			attr_dev(div, "slot", "status-badge");
    			add_location(div, file$5, 10, 4, 315);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img0);
    ...
    function create_logo_link_container_slot$2(ctx) {
    	...
    	logolink0 = new Logo_link({
    			props: {
    				link: "https://github.com/c1m50c/lists",
    				icon: Icons.Github
    			},
    			$$inline: true
    		});
    	...
    	logolink1 = new Logo_link({
    			props: {
    				link: "https://crates.io/crates/lists",
    				icon: Icons.CratesIO
    			},
    			$$inline: true
    		});
    	...
    	logolink2 = new Logo_link({
    			props: {
    				link: "https://docs.rs/crate/lists/latest",
    				icon: Icons.DocsRS
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink2.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$5, 18, 4, 1008);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink0, div, null);
    ...
    function create_fragment$5(ctx) {
    	...
    	projectcard = new Project_card({
    			props: {
    				...
    				background_url: "./projects/lists.png",
    				$$slots: {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Lists> was created with unknown prop '${key}'`);
    	});
    ...
    /* src\components\project-cards\evaluator.svelte generated by Svelte v3.42.5 */
    const file$4 = "src\\components\\project-cards\\evaluator.svelte";
    ...
    function create_status_badge_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			img2 = element("img");
    			if (!src_url_equal(img0.src, img0_src_value = "https://img.shields.io/github/workflow/status/c1m50c/evaluator/Build?style=for-the-badge")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "Build");
    			add_location(img0, file$4, 11, 8, 388);
    			if (!src_url_equal(img1.src, img1_src_value = "https://img.shields.io/tokei/lines/github/c1m50c/evaluator?style=for-the-badge")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "Lines of Code");
    			add_location(img1, file$4, 12, 8, 512);
    			if (!src_url_equal(img2.src, img2_src_value = "https://img.shields.io/github/license/c1m50c/evaluator?color=blue&style=for-the-badge")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "License");
    			add_location(img2, file$4, 13, 8, 634);
    			attr_dev(div, "slot", "status-badge");
    			add_location(div, file$4, 10, 4, 353);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img0);
    ...
    function create_logo_link_container_slot$1(ctx) {
    	...
    	logolink = new Logo_link({
    			props: {
    				link: "https://github.com/c1m50c/evaluator",
    				icon: Icons.Github
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$4, 15, 4, 765);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink, div, null);
    ...
    function create_fragment$4(ctx) {
    	...
    	projectcard = new Project_card({
    			props: {
    				title: "Evaluator",
    				description: "Shell based application that performs lexical analysis, parsing, and evaluation to determine an output.",
    				background_url: "./projects/evaluator.png",
    				$$slots: {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Evaluator', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Evaluator> was created with unknown prop '${key}'`);
    	});
    ...
    class Evaluator extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\project-cards\password_generator.svelte generated by Svelte v3.42.5 */
    const file$3 = "src\\components\\project-cards\\password_generator.svelte";
    ...
    function create_status_badge_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			img1 = element("img");
    			if (!src_url_equal(img0.src, img0_src_value = "https://img.shields.io/github/license/c1m50c/password-generator?color=blue&style=for-the-badge")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "License");
    			add_location(img0, file$3, 11, 8, 403);
    			if (!src_url_equal(img1.src, img1_src_value = "https://img.shields.io/tokei/lines/github/c1m50c/password-generator?style=for-the-badge")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "Lines of Code");
    			add_location(img1, file$3, 12, 8, 535);
    			attr_dev(div, "slot", "status-badge");
    			add_location(div, file$3, 10, 4, 368);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img0);
    ...
    function create_logo_link_container_slot(ctx) {
    	...
    	logolink = new Logo_link({
    			props: {
    				link: "https://github.com/c1m50c/password-generator",
    				icon: Icons.Github
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(logolink.$$.fragment);
    			attr_dev(div, "slot", "logo-link-container");
    			add_location(div, file$3, 14, 4, 674);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(logolink, div, null);
    ...
    function create_fragment$3(ctx) {
    	...
    	projectcard = new Project_card({
    			props: {
    				...
    				description: "Password Generator CLI written in Python, featuring QR Code Generation, Text File Saving, and more! ",
    				background_url: "./projects/password-generator.png",
    				$$slots: {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Password_generator', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Password_generator> was created with unknown prop '${key}'`);
    	});
    ...
    class Password_generator extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$2(ctx) {
    	...
    	let t6;
    	let sortingalgorithmvisualizer;
    	let t7;
    	let rustalgorithms;
    	let t8;
    	let rustdatastructures;
    	let t9;
    	let cellularautomata;
    	let current;
    	portfoliopc = new Portfolio({ $$inline: true });
    	lists = new Lists({ $$inline: true });
    	fixedvectors = new Fixed_vectors({ $$inline: true });
    	evaluator = new Evaluator({ $$inline: true });
    	passwordgenerator = new Password_generator({ $$inline: true });
    	sortingalgorithmvisualizer = new Sorting_algorithm_visualizer({ $$inline: true });
    	rustalgorithms = new Rust_algorithms({ $$inline: true });
    	rustdatastructures = new Rust_data_structures({ $$inline: true });
    	cellularautomata = new Cellular_automata({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			create_component(evaluator.$$.fragment);
    			t5 = space();
    			create_component(passwordgenerator.$$.fragment);
    			t6 = space();
    			create_component(sortingalgorithmvisualizer.$$.fragment);
    			t7 = space();
    			create_component(rustalgorithms.$$.fragment);
    			t8 = space();
    			create_component(rustdatastructures.$$.fragment);
    			t9 = space();
    			create_component(cellularautomata.$$.fragment);
    			attr_dev(h1, "class", "section-title");
    			add_location(h1, file$2, 22, 4, 890);
    			attr_dev(div0, "class", "project-card-container svelte-alykgw");
    			add_location(div0, file$2, 23, 4, 935);
    			attr_dev(div1, "class", "info-container");
    			attr_dev(div1, "id", "projects");
    			add_location(div1, file$2, 21, 0, 842);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, t2);
    			mount_component(lists, div0, null);
    			append_dev(div0, t3);
    			mount_component(fixedvectors, div0, null);
    			append_dev(div0, t4);
    			mount_component(evaluator, div0, null);
    			append_dev(div0, t5);
    			mount_component(passwordgenerator, div0, null);
    			append_dev(div0, t6);
    			mount_component(sortingalgorithmvisualizer, div0, null);
    			append_dev(div0, t7);
    			mount_component(rustalgorithms, div0, null);
    			append_dev(div0, t8);
    			mount_component(rustdatastructures, div0, null);
    			append_dev(div0, t9);
    			mount_component(cellularautomata, div0, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			...
    			transition_in(evaluator.$$.fragment, local);
    			transition_in(passwordgenerator.$$.fragment, local);
    			transition_in(sortingalgorithmvisualizer.$$.fragment, local);
    			transition_in(rustalgorithms.$$.fragment, local);
    			transition_in(rustdatastructures.$$.fragment, local);
    			transition_in(cellularautomata.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			...
    			transition_out(evaluator.$$.fragment, local);
    			transition_out(passwordgenerator.$$.fragment, local);
    			transition_out(sortingalgorithmvisualizer.$$.fragment, local);
    			transition_out(rustalgorithms.$$.fragment, local);
    			transition_out(rustdatastructures.$$.fragment, local);
    			transition_out(cellularautomata.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			...
    			destroy_component(evaluator);
    			destroy_component(passwordgenerator);
    			destroy_component(sortingalgorithmvisualizer);
    			destroy_component(rustalgorithms);
    			destroy_component(rustdatastructures);
    			destroy_component(cellularautomata);
    		}
    	};
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({
    		PortfolioPc: Portfolio,
    		CellularAutomata: Cellular_automata,
    		SortingAlgorithmVisualizer: Sorting_algorithm_visualizer,
    		RustAlgorithms: Rust_algorithms,
    		RustDataStructures: Rust_data_structures,
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "logo-link-container svelte-12j0kmi");
    			add_location(div0, file$1, 52, 4, 1353);
    			attr_dev(button, "id", "email");
    			attr_dev(button, "class", "svelte-12j0kmi");
    			add_location(button, file$1, 57, 4, 1610);
    			attr_dev(div1, "class", "info-container svelte-12j0kmi");
    			attr_dev(div1, "id", "contact");
    			add_location(div1, file$1, 51, 0, 1306);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1qb2ykx");
    			add_location(main, file, 94, 0, 3525);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
